...
#                print(filename)
                ...
                for line in fin:
                    if "RDMA" in line:
                        ...
                        if sys.argv[2] == '0':
#                            print(RDMA_time)
                            time_use = int(RDMA_time)
                        elif sys.argv[2] == '1':
#                            print(Compressed)
                            time_use=int(Compressed)
                        elif sys.argv[2] == '2':
                            time_use = int(Flash)
#                            print(Flash) 
...
#                            print( time_use )
                        if j < 5:
                            print( float(base)/float(time_use), "\t " , end="")
                        else:
                            print( float(base)/float(time_use) )
...
print(int(sys.argv[2]), [ int(sys.argv[1]) ] , int(sys.argv[1]) * 10 ,"%")
